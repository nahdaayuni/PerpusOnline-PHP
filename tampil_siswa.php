...
<body id="t01">
 ...
 <h3 align="center" id="t01">TAMPIL SISWA</h3>
 </br>
...
<td><?=$data_siswa['nama_kelas']?></td><td><a
href="ubah_siswa.php?id_siswa=<?=$data_siswa['id_siswa']?>"
...
onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
 ...
 <td><a href="tambah_siswa.php" class="btn btn-success" style="background-color: #0073e6;">Tambah Siswa</a>
 <script

...
<h2 align="center" >HISTORI PEMINJAMAN BUKU</h2>
</br>
</br>
<table class="table table-hover table-striped">
 <thead>
 <th>NO</th><th>Tanggal Pinjam</th><th>Tanggal Harus Kembali</th><th>Nama Buku</th>
 ...
 while($dt_histori=mysqli_fetch_array($qry_histori)){
    ...
    buku.id_buku=detail_peminjaman_buku.id_buku where id_peminjaman_buku = '".$dt_histori['id_peminjaman_buku']."'");
...
'".$dt_histori['id_peminjaman_buku']."'");
 ...
 if(mysqli_num_rows($qry_cek_kembali)>0){
    ...
    $button_kembali="<a href='kembali.php?id=".$dt_histori['id_peminjaman_buku']."' class='btn btn-warning' onclick='return confirm(\"Anda mengembalikan buku?\")'>Kembalikan</a>";
 }
 ?>
 <tr>
